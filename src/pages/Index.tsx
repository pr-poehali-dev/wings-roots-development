      ...
      >
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          <a href="#" className="flex flex-col items-center">
            ...
            />
            <p className="font-golos text-center leading-snug" style={{ fontSize: "0.65rem", color: "#4a4540", maxWidth: "180px" }}>
              АНО ДПО «НОЦ СМТ»<br />при поддержке Союза охраны психического здоровья
            </p>
          </a>
            ...
            <div className="rounded-3xl p-8 mb-8 border-2" style={{ backgroundColor: "#fff8f0", borderColor: "#c4763a" }}>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                <div className="flex-1">
                  <h3 className="font-cormorant text-2xl font-medium mb-2" style={{ color: "#2e2b27" }}>Вводный модуль «Опорность: основы подхода»</h3>
                  <p className="font-golos text-sm leading-relaxed mb-1 mt-2" style={{ color: "#4a4540" }}>
                    Доступен для отдельного приобретения.
                  </p>
                  <p className="font-golos text-sm leading-relaxed mb-5" style={{ color: "#c4763a" }}>
          ...
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a href="https://vk.ru/pekarskayasv" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 px-6 py-3 rounded-full font-golos text-sm transition-all duration-300 hover:scale-105" style={{ backgroundColor: "rgba(213,207,199,0.15)", color: "#d5cfc7" }}>
                <Icon name="Users" size={16} />
                <span><span style={{ opacity: 0.7 }}>Тренер группы</span> <strong style={{ color: "#fefefe" }}>Светлана</strong></span>
              </a>
            </div>
